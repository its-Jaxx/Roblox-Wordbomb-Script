...
local data = game:HttpGet("https://raw.githubusercontent.com/its-Jaxx/wordbomb-script/main/word-dict.txt", true)
...
local number1 = 0.175
local minDelay = number1
local maxDelay = 0.15
local typingspeed = number1
        ...
        if tbox.Visible then
            ...
            if firstword then
                ...
                for _, letter in pairs(string.split(firstword, "")) do
                    ...
                    task.wait(typingspeed + randomDelay)
